...
{
    /**
     * Helper function - check if provider is subscripted
     */
    private function is_subscriped(User $user){
        return $user->whereHas('subscriptions', function (Builder $q) {
            $q->where('has_ended', 0);
        })->count() > 0;
    }
    ...
    public function dashboard()
    {
        ...
        if ($user->user_type == 2) {
            ...
            $is_subscriped = $this->is_subscriped($user);
