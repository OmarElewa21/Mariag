    ...
    Route::get('/admin',function(){
        ...
        Route::name('admin.')->prefix('admin')->group(function () {
            ...
            Route::middleware(['admin'])->group(function () {
                ...
                Route::resource('subscriptions', SubscriptionsController::class)->except([
                    'show',
                ]);
        ...
        Route::name('user.')->prefix('user')->group(function () {
            ...
            Route::middleware(['auth','profile_is_update','inactive', 'update_subscription_validation'])->group(function () {
                ...
                Route::middleware('service_provider')->group(function () {
                    ...
                    // Plans
                    Route::get('plans', [SubscriptionPlansController::class, 'provider_show'])->name('plans');
                });
            });
        });
        ...
        Route::get('provider/subscribe/{plan_id}', [ProviderTransactionController::class, 'make_transaction'])->name('provider_subscribe');
        
        Route::get('provider/subscription/status', [ProviderTransactionController::class, 'process_callback']);
