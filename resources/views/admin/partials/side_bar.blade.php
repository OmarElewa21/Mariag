 <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown {{activeMenu('admin.plans*')}} {{activeMenu('admin.subscriptions*')}}">
                <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-id-card-alt"></i> <span>@changeLang('Subscription Plans')</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="{{route('admin.plans.index')}}">@changeLang('All Plans')</a></li>
